...
<link href="./js/bootstrap.esm.js" rel="stylesheet">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.js" integrity="sha256-htsAUOIgN8xkootpQUzmvaCbQo6x2PNMTD7kLWI6yYQ=" crossorigin="anonymous"></script>
	...
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha256-o+AsfCHj7A1M5Xgm1kJmZiGEIvMQEzQqrXz2072Gkkg=" crossorigin="anonymous"></script>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#"id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Moje konto </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			     <a class="dropdown-item" href="#">Moje konto </a>

                <a class="dropdown-item" href='arch.php'>Archiwum</a>
                <a class="dropdown-item" href='password_change.php'>Zmień hasło</a>
                                <div class="dropdown-divider"></div>

              </div>
            </li>
			  <li class="nav-item">
              <a class="nav-link"  href="#price_listA">Cennik</a>
            </li>
			  <li class="nav-item">
              <a class="nav-link"  href="rezerwacja.php">Zarezerwuj</a>
            </li>
			  <li class="nav-item">
              <a class="nav-link"  href="#promo">Promocje</a>
            </li>
            <li class="nav-item">
